...
$txt_files='文件';
$txt_dirs='文件夹';
$txt_last_commented="最近被评论的图片";
$txt_top_rated="高评分图片";
$txt_last_added="最近添加的图片";
$txt_last_added_per_directory="每个文件夹最近添加的一张图片";
...
$txt_option_rating="对这张图片评分";
$txt['Best rating'] = '高分';
$txt['Worst rating'] = '低分';
$txt['Rate !'] = 'Rate !';

$txt_back_dir='^返回^';
$txt_previous_image='&lt;- 前一张';
$txt_next_image='后一张 -&gt;';
$txt_hires_image=' +高分图片+ ';
$txt_lores_image=' -低分图片- ';

$txt_previous_page='&lt;- 前一页 -| ';
$txt_next_page=' |- 后一页 -&gt; ';
...
// Login page
$txt['authenticate yourself'] = '登录-授权';
$txt_login_form_login="用户名:";
$txt_login_form_pass="密码:";


// Add comment page
$txt_comment_form_name="用户名:";
$txt_remember_me="(记住用户)";
$txt_comment_form_comment="你的评论:";
...
// SLIDESHOW
$txt['slideshow'] = '图片展示器';
$txt['Slideshow previous'] = '&larr; 前一张';
$txt['Slideshow next'] = '后一张 &rarr;';
$txt['Slideshow play'] = '播放';
$txt['Slideshow pause'] = '暂停';
$txt['Slideshow close'] = '关闭';
$txt['Slideshow delay'] = '播放间隔';
$txt['Slideshow %s sec'] = '%s 秒.';
$txt['Slideshow slower'] = '+';
$txt['Slideshow faster'] = '-';
$txt['Slideshow hide captions'] = '隐藏操作栏';
$txt['Slideshow show captions'] = '显示操作栏';
...
$txt_admin['admin'] = '菜单';
$txt_admin['Admin menu'] = '菜单';
$txt_admin['Create a new directory'] = "创建文件夹";
$txt_admin['Upload pictures/files'] = "上传(请先进入文件夹)";
$txt_admin['Batch Processing'] = '批量处理文件';
$txt_admin['phpGraphy Settings'] = '系统设置';
$txt_admin['Manage Users'] = '用户管理';
$txt_admin['View logfile'] = '查看Log';
